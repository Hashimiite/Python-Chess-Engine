class GameState:
    ...
    def makeMove(self, move):
        ...
        self.move_log.append(move)  # log the move so it can be undone
    ...
    def undoMove(self):#Undo the last move
